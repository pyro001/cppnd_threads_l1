...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    std::promise<void> prms_vehicle_entry_add;
    std::future<void> ftr_vehicle_entry_add=prms_vehicle_entry_add.get_future();
    _waitingVehicles.pushBack(std::move(vehicle),std::move(prms_vehicle_entry_add));
    ftr_vehicle_entry_add.wait();
